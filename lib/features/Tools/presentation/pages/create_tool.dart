...
class CreateToolFormPage extends StatefulWidget {
  const CreateToolFormPage({super.key});

  @override
  State<CreateToolFormPage> createState() => _CreateToolFormPageState();
}

class _CreateToolFormPageState extends State<CreateToolFormPage> {
  String toolName = '', description = '', qty = '';
                  ...
                  SJAButton(
                    ...
                    onTap: () => showDialog(
                      ...
                      builder: (context) => SJAPopUp(
                        text: 'Apakah anda yakin ingin menambah data alat ini?',
                        yaOnTap: () {
                          int count = 0;
