...
class EditInventoryFormPage extends StatefulWidget {
  const EditInventoryFormPage({super.key});

  @override
  State<EditInventoryFormPage> createState() => _EditInventoryFormPageState();
}

class _EditInventoryFormPageState extends State<EditInventoryFormPage> {
  String toolName = 'Logam Lembaran',
      description =
                  ...
                  SJAButton(
                    ...
                    onTap: () => showDialog(
                      ...
                      builder: (context) => SJAPopUp(
                        text:
                            'Apakah anda yakin ingin mengubah data bahan ini?',
                        yaOnTap: () {
                          int count = 0;
